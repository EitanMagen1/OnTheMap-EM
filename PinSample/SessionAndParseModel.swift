...
class SessionAndParseModel {
    ...
    func sessionAndParseTask(request: NSMutableURLRequest, client: ClientSelection, completionHandler: (result: AnyObject!, error: NSError?) -> Void) -> NSURLSessionDataTask {
